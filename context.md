...
- `scripts/browser-regressions.js` — headless Chrome/CDP regression suite that starts an isolated server and verifies readable-terminal Hermes palette ANSI styles, empty-reader non-blanking, and no stale-capture flicker while typing.
